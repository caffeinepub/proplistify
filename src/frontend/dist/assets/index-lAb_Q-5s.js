import { R as React__default, r as reactExports, aa as vt } from "./index-BANSdmlz.js";
var jt = (n) => {
  switch (n) {
    case "success":
      return ee;
...
var ve = (n) => {
  ...
  let { invert: e, toast: t, unstyled: a, interacting: u, setHeights: f, visibleToasts: w, heights: S, index: g, toasts: i, expanded: D, removeToast: T, defaultRichColors: F, closeButton: et, style: ut, cancelButtonStyle: ft, actionButtonStyle: l, className: ot = "", descriptionClassName: at = "", duration: X, position: st, gap: pt, loadingIcon: rt, expandByDefault: B, classNames: s, icons: P, closeButtonAriaLabel: nt = "Close toast", pauseWhenPageIsHidden: it } = n, [Y, C] = React__default.useState(null), [lt, J] = React__default.useState(null), [W, H] = React__default.useState(false), [A, mt] = React__default.useState(false), [L, z] = React__default.useState(false), [ct, d] = React__default.useState(false), [h, y] = React__default.useState(false), [R, j] = React__default.useState(0), [p, _] = React__default.useState(0), O = React__default.useRef(t.duration || X || Wt), G = React__default.useRef(null), k = React__default.useRef(null), Vt = g === 0, Ut = g + 1 <= w, N = t.type, V = t.dismissible !== false, Kt = t.className || "", Xt = t.descriptionClassName || "", dt = React__default.useMemo(() => S.findIndex((r) => r.toastId === t.id) || 0, [S, t.id]), Jt = React__default.useMemo(() => {
    var r;
    return (r = t.closeButton) != null ? r : et;
  }, [t.closeButton, et]), Tt = React__default.useMemo(() => t.duration || X || Wt, [t.duration, X]), gt = React__default.useRef(0), U = React__default.useRef(0), St = React__default.useRef(0), K = React__default.useRef(null), [Gt, Qt] = st.split("-"), Rt = React__default.useMemo(() => S.reduce((r, m, c) => c >= dt ? r : r + m.height, 0), [S, dt]), Et = Ft(), qt = t.invert || e, ht = N === "loading";
  U.current = React__default.useMemo(() => dt * pt + Rt, [dt, Rt]), React__default.useEffect(() => {
    O.current = Tt;
